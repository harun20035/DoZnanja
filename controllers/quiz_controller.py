...
from services.quiz_service import create_quiz_service
...
@router.post("/create")
def create_quiz_controller(quiz_data: QuizCreate, db: SessionDep, current_user: User = Depends(get_current_user)):
    try:
